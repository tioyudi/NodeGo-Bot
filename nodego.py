...
class NodeGo:
    ...
    def print_message(self, account, proxy, color, message):
        print(
            f"{Fore.CYAN + Style.BRIGHT}📧 [ Account: {Style.RESET_ALL}{Fore.WHITE + Style.BRIGHT}{account} {Style.RESET_ALL}"
            f"{Fore.MAGENTA + Style.BRIGHT} - {Style.RESET_ALL}"
            f"{Fore.CYAN + Style.BRIGHT} Proxy: {Style.RESET_ALL}{Fore.WHITE + Style.BRIGHT}{proxy}{Style.RESET_ALL}"
            f"{Fore.MAGENTA + Style.BRIGHT} - {Style.RESET_ALL}"
            f"{Fore.CYAN + Style.BRIGHT} Status: {Style.RESET_ALL}{color + Style.BRIGHT} {message} {Style.RESET_ALL} ]"
        )
        print(f"{Fore.CYAN + Style.BRIGHT}{'-' * 50}{Style.RESET_ALL}")  # Garis pemisah setelah setiap pesan
